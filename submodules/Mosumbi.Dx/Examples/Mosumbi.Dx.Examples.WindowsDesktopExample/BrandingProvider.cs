...
namespace Mosumbi.Dx.Examples.WindowsDesktopExample;
...
internal class BrandingProvider : IBrandingProvider
{
    ...
    {
        using var mrs = typeof(BrandingProvider).Assembly.GetManifestResourceStream("Mosumbi.Dx.Examples.WindowsDesktopExample.ImmyBot.png");
